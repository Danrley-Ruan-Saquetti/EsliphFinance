...
- **summary**: a afirmação em uma frase — o que está errado, terminando com a âncora entre parênteses (a RN, o documento ou a seção de padrão violada — ex.: "(RN-0010)", "(docs/domains/account.md)").
